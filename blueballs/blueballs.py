...
class BlueBalls(Animation):
    ...
    def drawScore(self, screen):
        ...
        self.scoreText = pygame.font.Font(None, int(self.width / 25))
...
class Court(object):
    ...
    def drawDiags(self, screen):
        ...
        for point in range(pointsInBox) :
...
class Music(object):
    ...
    def getGameSounds(self):
        directory = os.getcwd() + "/blueballs/utils/sounds/"
...
class Button(object):
    ...
    def loadImages(self):
        directory = os.getcwd() + "/blueballs/utils/images/"
...
'''Carpe Diem.''', '''aka #yolo''',]
    ...
    def drawHelpText(self, screen):
        ...
        for text in self.helpInstruc :
            help = pygame.font.Font(None, int(width / 25))
    ...
    def drawLevelOneText(self, screen):
        levelOne = pygame.font.Font(None, int(self.width / 10))
        levelMessage = pygame.font.Font(None, int(self.width/ 22))
